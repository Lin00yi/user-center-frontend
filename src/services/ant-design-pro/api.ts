...
/** 获取搜索用户 GET /api/search */
export async function SearchUsers(body:API.SearchUsersParams,options?: { [key: string]: any }) {
...
/** 更新单个用户 GET /api/update */
export async function updateUser(body:API.SearchUsersParams, options?: { [key: string]: any }) {
